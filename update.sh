...
traitement(){
    ...
    then
        echo "************************* Push data *************************************************"
        # connect virtualenv
        python ~/niamoto-portal/manage.py dumpdata --exclude=contenttypes > data.json
        sshpass -p $SSHPASSWORD scp -P $PORT data.json niamoto@niamoto.ddns.net:/home/niamoto/data
